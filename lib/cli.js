...
const HELP = `
  ...
  Options:
    ...
    --online         Enable network calls for provenance checks on scan --mcp
                     (transmits package names to registry.npmjs.org; opt-in, default off)
  ...
  Examples:
    ...
    npx llm-safe-haven scan --mcp --online  # Scan MCP configs with live registry provenance checks
