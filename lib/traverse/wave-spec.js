...
// The opening sequence of a POSIX bracket class (`[[:space:]]`,
// `[[:alpha:]]`, ...). Deliberately the SAME expression as the test-side
// drift guard in tests/traverse/wave-spec.test.js, so the validator and the
// test cannot disagree about what counts as a POSIX class (G-1552).
