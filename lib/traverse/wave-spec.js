...
//
// Token form was chosen over the broader `/\[\^?[^\]]*\[:/` because that
// alternative false-positives on legitimate patterns such as
// `\[\[:not-a-class` and `[\[:]`, while this one has zero false positives
// across the four shipped JS-regex fields and a legit-pattern corpus.
//
...
// disagree about what counts as a POSIX class (G-1552).
