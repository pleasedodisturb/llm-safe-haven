...
// (today, only `unreadable`) has no such pre-existing channel and is
// counted directly off the skip inventory by `countAnomalySkips` below.
 ...
 * today, that is `unreadable` alone. Driven by `ANOMALY_SKIP_REASONS`
