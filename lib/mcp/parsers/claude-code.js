 ...
 * pollution key (`__proto__`/`constructor`/`prototype`) — i.e. the
 * object's ONLY content was hostile, so a silently-empty server list
 * would misrepresent an attack as "nothing configured".
 *
