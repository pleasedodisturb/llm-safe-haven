 ...
 * detector consumes — never raw per-agent JSON/YAML. Missing inputs
 * default to null/[]/{} rather than being omitted, so downstream code
 * can rely on every key always being present.
 *
