...
module.exports = {
  ...
  // Declared capabilities (G-1661, plan 21-06/21-07).
  ...
  ignoreFileCitation: {
    ...
    claim: '.aiderignore tells aider to ignore parts of the repo not relevant to the task, following .gitignore syntax and conventions; no bypass caveat found.',
  },
  detect,
  harden,
  audit,
