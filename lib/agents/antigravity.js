...
module.exports = {
  ...
  // unanticipated by ROADMAP criterion 6). cited-inert: Antigravity's own
  // Strict Mode settings doc names .gitignore, not .antigravityignore, as
  // the respected file.
  tier: 3,
  ...
  ignoreFileCitation: {
    ...
    claim: 'Antigravity\'s Strict Mode settings doc states the Agent will "Respect .gitignore" rules -- naming .gitignore, not .antigravityignore, as the respected file (cited-inert).',
  },
  detect,
  harden,
  audit,
