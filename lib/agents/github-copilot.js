...
module.exports = {
  name: 'GitHub Copilot',
  id: 'github-copilot',
  // Stays tier 3 (G-1661, plan 21-06/21-07, D-01-fixed / ROADMAP
  // criterion 6). cited-inert: Copilot content exclusion is configured
  // server-side by repo/org/enterprise admins -- the local .copilotignore
  // this harden() writes is not what the product reads.
  tier: 3,
  ...
  ignoreFileCitation: {
    ...
    claim: 'Repository administrators, organization owners, and enterprise owners manage content exclusion server-side (Copilot Business/Enterprise); the page names zero local .copilotignore mechanism (cited-inert).',
  },
  detect,
  harden,
  audit,
