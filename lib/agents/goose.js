...
module.exports = {
  ...
  // unanticipated by ROADMAP criterion 6). cited-inert: Goose's own
  // codebase-analysis guide names .gitignore, not .gooseignore, as the
  // respected exclusion mechanism.
  tier: 3,
  ...
  ignoreFileCitation: {
    ...
    claim: 'Goose\'s own codebase-analysis guide instructs using .gitignore files to exclude files from analysis, naming .gitignore -- not .gooseignore -- as the respected mechanism (cited-inert).',
  },
  detect,
  harden,
  audit,
