...
/**
 * Minimal human-readable presentation of the scan-mcp.js envelope.
 * Full presentation (per-source table, per-server detail) is deferred to
 * Phase 7 — this stub just prints a header, a scanned-sources/servers
 * count, and a PASS line for the (currently always empty) findings array.
 * Never crashes on findings:[] or servers:[] (defensive defaults below).
 */
