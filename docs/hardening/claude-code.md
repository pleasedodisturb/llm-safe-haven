...
- **May 2026 SOCKS5 null-byte sandbox bypass (silently fixed)**: A SOCKS5 hostname null-byte injection caused the sandbox allowlist to terminate string comparison early, permitting egress to blocked domains that appeared to match allowed ones. No CVE issued, no public advisory — discovered by diffing versions. This is the second silent Claude Code sandbox bypass fix in five months. ([The Register — May 20, 2026](https://www.theregister.com/security/2026/05/20/even-claude-agrees-hole-in-its-sandbox-was-real-and-dangerous/5243662))
