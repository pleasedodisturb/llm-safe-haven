...
| [Socket: "npm Invalidates Granular Access Tokens as Mini Shai-Hulud Swells"](https://socket.dev/blog/npm-invalidates-tokens-mini-shai-hulud) | May 19, 2026 | Platform-wide reset of ~61,274 bypass-2FA granular access tokens after the May 18 @antv compromise (639 versions, 323 packages). Full Mini Shai-Hulud campaign now spans 1,055 versions across 502 packages. Recommends `minimumReleaseAge` + OIDC trusted publishing + staged publishing. |
| [StepSecurity: "Mini Shai-Hulud Is Back" (TanStack wave)](https://www.stepsecurity.io/blog/mini-shai-hulud-is-back-a-self-spreading-supply-chain-attack-hits-the-npm-ecosystem) | May 11, 2026 | CVE-2026-45321 (CVSS 9.6). 84 versions across 42 @tanstack packages + Mistral AI + Guardrails AI + UiPath + OpenSearch. Novel TTP: OIDC token scraped from /proc/Runner.Worker memory; valid Sigstore provenance on malicious versions. Confirms `.claude/settings.json` SessionStart + `.vscode/tasks.json` folderOpen weaponization. |
...
| [Microsoft Security: "Mini Shai-Hulud Compromised @antv npm Packages"](https://www.microsoft.com/en-us/security/blog/2026/05/20/mini-shai-hulud-compromised-antv-npm-packages-enable-ci-cd-credential-theft/) | May 20, 2026 | 22-minute automated burst at 01:56–02:56 UTC May 19. 42 packages with forged Sigstore provenance badges. Payload: 20+ credential types, GH Actions runner memory scraping, sudoers + DNS persistence, Docker socket escape attempt. Exfil at t.m-kosche[.]com. |
