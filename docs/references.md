...
| [Cisco AI Agent Security Scanner for IDEs](https://blogs.cisco.com/ai/introducing-the-ai-agent-security-scanner-for-ides-verify-your-agents) | — | VS Code / JetBrains extension bundling Cisco's MCP Scanner and Skill Scanner. Surfaces security findings inline as agents are installed or configured — brings MCP and skill supply chain security into the IDE workflow. May 2026. |
